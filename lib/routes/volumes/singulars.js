...
module.exports = function (router,ufs) {
  ...
  router.get(/\/ls\/(.*)/, function(req, res) {
    ufs.readdir(req.session.ufs, "/"+ req.params[0])
  ...
  router.put(/\/mkdir\/(.*)/, function(req, res) {
    ufs.mkdir(req.session.ufs, "/"+ req.params[0])
    .then(function(result) {
      res.send(result);
    })
    .catch(function(err) {
  ...
  router.put(/\/put\/(.*)/, function(req, res) {
    ufs.writeFile(req.session.ufs, "/"+ req.params[0], req.body.content)
    .then(function(result) {
      res.send(result);
    })
    .catch(function(err) {
  ...
  router.get(/\/get\/(.*)/, function(req, res) {
    ufs.readFile(req.session.ufs, "/"+ req.params[0])
    .then(function(result) {
      res.send(result);
    })
    .catch(function(err) {
  ...
  router.patch(/\/mv\/(.*)/, function(req, res) {
    ufs.move(req.session.ufs, "/"+ req.params[0], req.body.destination)
    .then(function(result) {
      res.send(result);
    })
    .catch(function(err) {
  ...
  router.delete(/\/rm\/(.*)/, function(req, res) {
    ufs.unlink(req.session.ufs, "/"+ req.params[0])
    .then(function(result) {
      res.send(result);
    })
    .catch(function(err) {
  ...
  router.delete(/\/rmdir\/(.*)/, function(req, res) {
    ufs.rmdir(req.session.ufs, "/"+ req.params[0])
    .then(function(result) {
      res.send(result);
    })
    .catch(function(err) {
  ...
  router.post(/\/cp\/(.*)/, function(req, res) {
    ...
    .pipe(res);
    */
    ufs.copy(req.session.ufs, req.params[0], req.body.destination)
    .then(function(result) {
      res.send(result);
    })
    .catch(function(err) {
  ...
  router.get(/\/stat\/(.*)/, function(req, res) {
    ufs.stat(req.session.ufs, req.params[0])
    .then((result) => {
      res.send(result);
    })
    .catch((err) => {
