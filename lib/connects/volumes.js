...
class VolumesConnector {
   ...
   */
   setAccessToken(  token,connectorName,) {
      return this.callMethod(connectorName,  'setAccessToken', token);
   }
   ...
   */
   readdir( path) {
      ...
      console.log("parsed:");
      console.dir(parsed);
      return this.callMethod(parsed.connectorName,  'readdir', parsed.path);
   }
   ...
   */
   stat( path) {
      var parsed = parsePath(path);
      return this.callMethod(parsed.connectorName,  'stat', path);
   }
