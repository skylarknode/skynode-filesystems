...
class FileSystem {
   ...
   */
   constructor(connector,session) {
      ...
      if (connector && connector.load && session) {
   ...
   */
   setCredentials(token,connectorName) {
      return this.callMethod('setCredentials', token,connectorName);
   }
   ...
   */
   ...
   archive(paths,to,options) {
      return this.callMethod( 'archive', paths,to,options);
   }
   ...
   */
   list( path,options) {
      return this.callMethod( 'list', path,options);
   }
   ...
   */
   remove( path) {
      return this.callMethod(  'remove', path);
   }
   ...
   */
   ...
   thumbnail(path,options) {
      return this.callMethod(  'thumbnail', path,options);
   }
